...
class Cell:
    ...
    def __sub__(self, other):
        ...
        if sub < 0:
            ...
            return f'Выполняем вычитание: {Cell(sub)}\n'

    def __mul__(self, other):
        return f'Выполняем умножение: {Cell(self.quantity * other.quantity)}\n'
    ...
    def make_order(self, cells_in_line):
        line = ''
        for i in range(int(self.quantity / cells_in_line)):     # кол-во рядов
            line += f'{"*" * cells_in_line} \n'                 # заполняем каждый ряд
        line += f'{"*" * (self.quantity % cells_in_line)} \n'   # послдений ряд(остаток от деления)
        return line 


cell1 = Cell(input('Введите кол-во ячеек:\t'))
cell2 = Cell(input('Введите кол-во ячеек:\t'))
cell3 = Cell(input('Введите кол-во ячеек:\t'))
cell4 = Cell(input('Введите кол-во ячеек:\t'))
print()
print(cell1 + cell2)
print(cell2 - cell3)
print(cell3 - cell2)
