...
- любая многострочная строка после заголовка класса сохраняется в переменную __doc__
- чтобы вывести информацию можно напрямую обращаться к дандер-переменной __doc__
