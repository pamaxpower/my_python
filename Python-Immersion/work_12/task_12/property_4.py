'''
Deleter
- изменяет поведение при попытке удалить свойство командой del
...
# Создание делейтера аналогично созданию сеттера, только на вход не передается параметр, 
# а внутри прописывается логика поведения