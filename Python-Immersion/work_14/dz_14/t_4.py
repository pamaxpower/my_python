...
test_employee_birthday: Тестирование метода birthday(). 
    ...
    Создайте объект Employee с возрастом 30, вызовите метод birthday() и 
    убедитесь, что возраст увеличился на 1 и стал равным 31.

test_employee_raise_salary: Тестирование метода raise_salary(). 

    Создайте объект Employee с зарплатой 50000, вызовите метод raise_salary(10) и 
    убедитесь, что зарплата увеличилась на 10% и стала равной 55000.0.

test_employee_str: Тестирование метода __str__(). 
    Создайте объект Employee с данными: фамилия "Ivanov", имя "Ivan", отчество "Ivanovich", возраст 30, должность "manager" и зарплата 50000. 
...
test_employee_last_name_title: Тестирование атрибута last_name. 
    ...
    Создайте объект Employee с фамилией "Ivanov" и 
...
class TestEmployee(unittest.TestCase):
    ...
    def test_employee_full_name(self):
        self.assertEqual(Person('Ivanov', 'Ivan', 'Ivanovich', 30).full_name(),
                         'Ivanov Ivan Ivanovich')

    def test_employee_birthday(self):
        e1 = Person('Ivanov', 'Ivan', 'Ivanovich', 30)
        e1.birthday()
        self.assertEqual(e1.get_age(), 31)

    def test_employee_raise_salary(self):
        e2 = Employee('Ivanov', 'Ivan', 'Ivanovich', 30, 'manager', 50000)
        e2.raise_salary(10)
        self.assertEqual(e2.salary, 55000.0)

    def test_employee_str(self):
        self.assertEqual(
            str(Employee('Ivanov', 'Ivan', 'Ivanovich', 30, 'manager', 50000)),
            'Ivanov Ivan Ivanovich (Manager)')

    def test_employee_last_name_title(self):
        self.assertEqual(Employee('ivanov', 'ivan', 'ivanovich', 30, 'manager',
                                  50000).last_name, 'Ivanov')
